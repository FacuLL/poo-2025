...
public class LoungeTester {
    public static void main(String[] args) {
        ...
        // de todas las aerolíneas que cuenten con al menos un pase cuando está abierto
        CapacityLounge capLounge = new CapacityLounge(central, "The Centurion", 3);
        ...
        AirlineCapacityLounge airLounge = new AirlineCapacityLounge(central, "VIP Lounge", 4, "LATAM");
